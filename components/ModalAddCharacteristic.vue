<template>
    <modal name="add-characteristic" height="auto" :width="500" :scrollable="true"
        @before-open="selected = value.slice()">
            ...
            <div class="modal-add-characteristic__wrapper">
                ...
                <div class="modal-add-characteristic__footer d-flex justify-content-center">
                    <v-btn class="btn_disable btn_gray-light btn_md btn_height-md"
                           ...
                           @click.prevent="$emit('input', selected); $modal.hide('add-characteristic')">Добавить
                    </v-btn>
                </div>
            </div>
        </div>
