    ...
    <div class="content-main__wrapper">
        ...
        <div class="d-flex flex-wrap align-items-center mb-2">
            ...
            <v-multiselect
                class="multiselect-filter mb-2"
                :value="type"
                @input="$router.replace({ path: '/catalog2', query: Object.assign({}, $route.query, { type: $event }) })"
                    ...
                    <tr>
                        ...
                        <td class="page__attrs-table-filter">
                            <span @click="updateSort('model_id')">ID
                                <icon-base v-if="sort != 'model_id'" icon="filter"/>
                                <icon-base v-if="sort == 'model_id' && order == 'desc'" icon="filter-up"/>
                                <icon-base v-if="sort == 'model_id' && order == 'asc'" icon="filter-down"/>
                            </span>
                        </td>
                        <td class="page__attrs-table-filter">
                            <span @click="updateSort('image')">Image
                                <icon-base v-if="sort != 'image'" icon="filter"/>
                                <icon-base v-if="sort == 'image' && order == 'desc'" icon="filter-up"/>
                                <icon-base v-if="sort == 'image' && order == 'asc'" icon="filter-down"/>
                            </span>
                        </td>
                        <td class="td-name">
                            <span @click="updateSort('name')">Название
                                <icon-base v-if="sort != 'name'" icon="filter"/>
                                <icon-base v-if="sort == 'name' && order == 'desc'" icon="filter-up"/>
                                <icon-base v-if="sort == 'name' && order == 'asc'" icon="filter-down"/>
                            </span>
                        </td>
                        <td class="td-date">
                            <span @click="updateSort('created_at')">Дата создания
                                <icon-base v-if="sort != 'created_at'" icon="filter"/>
                                <icon-base v-if="sort == 'created_at' && order == 'desc'" icon="filter-up"/>
                                <icon-base v-if="sort == 'created_at' && order == 'asc'" icon="filter-down"/>
                            </span>
                        </td>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <v-pagination :total_pages="totalPages"
                    :params="$route.query"/>
            </div>
        </div>
        <div>
            ...
            <modal-base name="model-search" :width="400">
                <model-search-by-id @input="$modal.hide('model-search')"/>
            </modal-base>
